...
WebSocket offline backoff is disabled by default and can be enabled under Extra. Only new agent log events are considered after enabling it. Scheduled agent updates and periodic restarts are deferred while the manager has paused the agent.
